...
- **Bash**: `.agents/skills/avm-terraform-development/scripts/azure-schema`
- **PowerShell**: `.agents/skills/avm-terraform-development/scripts/azure-schema.ps1`

### List available API versions

```bash
.agents/skills/avm-terraform-development/scripts/azure-schema versions Microsoft.Storage
```

```powershell
.agents/skills/avm-terraform-development/scripts/azure-schema.ps1 versions Microsoft.Storage
```

### Get a resource schema (human-readable)

```bash
.agents/skills/avm-terraform-development/scripts/azure-schema get Microsoft.Storage/storageAccounts 2023-01-01
```

```powershell
.agents/skills/avm-terraform-development/scripts/azure-schema.ps1 get Microsoft.Storage/storageAccounts 2023-01-01
```

### Get a resource schema (resolved JSON)

```bash
.agents/skills/avm-terraform-development/scripts/azure-schema get Microsoft.Storage/storageAccounts 2023-01-01 --json
```

```powershell
.agents/skills/avm-terraform-development/scripts/azure-schema.ps1 get Microsoft.Storage/storageAccounts 2023-01-01 -Json
```
...
.agents/skills/avm-terraform-development/scripts/azure-schema get Microsoft.Storage/storageAccounts 2023-01-01 --depth 2

# Deep view (default is 5)
.agents/skills/avm-terraform-development/scripts/azure-schema get Microsoft.Storage/storageAccounts 2023-01-01 --depth 8
```

```powershell
# Shallow view (top-level properties only)
.agents/skills/avm-terraform-development/scripts/azure-schema.ps1 get Microsoft.Storage/storageAccounts 2023-01-01 -Depth 2

# Deep view (default is 5)
.agents/skills/avm-terraform-development/scripts/azure-schema.ps1 get Microsoft.Storage/storageAccounts 2023-01-01 -Depth 8
```
