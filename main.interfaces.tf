...
resource "azurerm_management_lock" "this" {
  count = var.existing_virtual_network == null ? (var.lock != null ? 1 : 0) : 0
...
resource "azurerm_role_assignment" "vnet_level" {
  for_each = var.existing_virtual_network == null ? var.role_assignments : {}
...
resource "azurerm_monitor_diagnostic_setting" "example" {
  ...
  for_each = var.existing_virtual_network == null ? {
