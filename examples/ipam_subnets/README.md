<!-- BEGIN_TF_DOCS -->
# Simple example for the Azure Virtual Network module with IPAM support and subnets

This shows how to create and manage Azure Virtual Networks (vNets) while receiving an address\_space from the IPAM service and creating subnets with dynamic address\_prefixes
...
- [azapi_resource.pool](https://registry.terraform.io/providers/Azure/azapi/latest/docs/resources/resource) (resource)
